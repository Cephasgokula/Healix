...
const SendMail = async (email,otp,UserName, template) => {
  try {
    ...
    if (template === "registration") {
      subject = "Welcome to Qurelio - Registration OTP";
      text =
        `Hello ${UserName},\n\n` +
        `Thank you for choosing Qurelio! You're just one step away from getting started.` +
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td>
                    ...
                    <h1 style="color: rgb(8, 32, 169); user-select:none">Qurelio</h1>
                    </div>
                  </td>
                </tr>
                <tr>
                  <td style="padding: 20px 0;">
                    ...
                    <p style="font-size: 16px; color: #666666;">Thank you for choosing Qurelio! You're just one step away
                    ...
                    <p style="font-size: 16px; color: #666666;">Best regards,<br>The Qurelio Team</p>
                  </td>
                </tr>
              </table>
            </td>
      ...
      subject = "Qurelio-Your password is changed!!";
      text =
        `Hello ${UserName} ,\n\n` +
        `You have changed your password for your Qurelio account.` +
            ...
            <td style="padding: 30px;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                  <td>
                    <p style="font-size: 18px; color: #333333;">Hello ${UserName},</p>
                    <p style="font-size: 16px; color: #666666;">You have changed your password for your Qurelio account.
                      account.</p>
                ...
                <tr>
                  <td>
                    ...
                    <p style="font-size: 16px; color: #333333; font-weight: bold;">The Qurelio Team</p>
                  </td>
                </tr>
              </table>
            </td>
      ...
      subject = "Qurelio-Otp to change your password!!";
      text =
        `Hello ${UserName} ,\n\n` +
        `You have forgot your password for your Qurelio account.` +
            ...
            <td style="padding: 30px;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                  <td>
                    <p style="font-size: 18px; color: #333333;">Hello ${UserName},</p>
                    <p style="font-size: 16px; color: #666666;">You have forgot your password for your Qurelio account</p>
      ...
      text =
        `Hello ${UserName},\n\n` +
        `You have requested the deletion of your account for your Qurelio account.` +
        ...
        `Before deleting your account, please ensure that you've backed up any important data associated with your Qurelio account.\n\n` +
        `Best regards,\n` +
        `The Qurelio Team`;
                ...
                <tr>
                  <td>
                    ...
                    <p style="font-size: 16px; color: #666666; margin-top: 20px;">Before deleting your account, please ensure
                      that you've backed up any important data associated with your Qurelio account.</p>
                  </td>
                </tr>
                <tr>
                  <td>
      ...
      text =
        `Hello ${UserName},\n\n` +
        `Your Qurelio account has been successfully deleted as per your request.` +
            ...
            <td style="padding: 30px;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                  <td>
                    <p style="font-size: 18px; color: #333333;">Hello ${UserName},</p>
                    <p style="font-size: 16px; color: #666666;">Your Qurelio account has been successfully deleted as per
                      your request.</p>
      ...
      text =
        `Hello ${UserName},\n\n` +
        `You have requested to resend the OTP for your Qurelio account.` +
        `Here's your OTP: ${otp}\n\n` +
              ...
              <td style="padding: 30px;">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  ...
                  <tr>
                    <td>
                      <p style="font-size: 18px; color: #333333;">Hello ${UserName},</p>
                      <p style="font-size: 16px; color: #666666;">You have requested to resend the OTP for your Qurelio account.</p>
